 ...
 * @since  1.6
 */
class Modern_toursViewLeavereview extends JViewLegacy
{
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$this->params = $app->getParams('com_modern_tours');
	...
	{
		$id = $this->item->params->{$field} ? $this->item->params->{$field} : MTHelper::getComponentParams($field);

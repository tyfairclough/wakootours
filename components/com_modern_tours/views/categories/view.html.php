...
class Modern_toursViewCategories extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->params = JFactory::getApplication()->getParams('com_modern_tours');
		$this->col_lg = (empty($this->params->get('col_lg') ? 'col-lg-'.MTHelper::getComponentParams('list_items') : $this->params->get('col_lg')));

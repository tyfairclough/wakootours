    ...
    <div>
        <ul class="asset-steps">
            <li class="active" step="1">
                1. <?php echo JText::_( 'FILL_USER_INFORMATION' ); ?></li>
            <li step="2"><svg viewBox="0 0 18 18" role="presentation" aria-hidden="true" focusable="false" style="height: 10px; width: 10px; fill: rgb(118, 118, 118);"><path d="m4.29 1.71a1 1 0 1 1 1.42-1.41l8 8a1 1 0 0 1 0 1.41l-8 8a1 1 0 1 1 -1.42-1.41l7.29-7.29z" fill-rule="evenodd"></path></svg>
                2. <?php echo JText::_( 'CONFIRM_AND_PAY' ); ?></li>
        </ul>
    </div>
    <div class="row">

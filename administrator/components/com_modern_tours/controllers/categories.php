 ...
 * @since  1.6
 */
class Modern_toursControllerCategories extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_modern_tours&view=categories');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'category', $prefix = 'Modern_toursModel', $config = array())
	{

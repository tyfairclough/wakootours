 ...
 * @since  1.6
 */
class Modern_toursControllerReviews extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_modern_tours&view=reviews');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'review', $prefix = 'Modern_toursModel', $config = array())
	{

...
/**
 * Toursemails list controller class.
 *
 * @since  1.6
 */
class Modern_toursControllerToursemails extends JControllerAdmin
{
	/**
	 * Method to clone existing Toursemails
	 *
	 * @return void
	 */
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'toursemail', $prefix = 'Modern_toursModel', $config = array())
	{

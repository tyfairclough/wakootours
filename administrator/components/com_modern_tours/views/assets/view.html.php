 ...
 */
class Modern_toursViewAssets extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        Modern_toursHelper::addSubmenu('assets');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_MODERN_TOURS_TITLE'), 'assets.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_modern_tours&view=assets');
	...
	protected function getSortFields()
	{
		...
		'a.`times`' => JText::_('COM_MODERN_TOURS_MODERNTIMES_TIMES'),
		);
	}

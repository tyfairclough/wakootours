 ...
 * @since  1.6
 */
class Modern_toursViewCategory extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MODERN_TOURS_TITLE_CATEGORY'), 'category.png');
...
//			JToolbarHelper::versions('com_modern_tours.category', $this->item->id);
//		}

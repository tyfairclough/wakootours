...
$title = ($id ? JText::_('EDIT_REVIEW') : JText::_('ADD_REVIEW'));
?>
<style>
    #myTabTabs { display:none; } .form-horizontal .control-group { margin: 0; width: 58%; background: white; padding: 15px; border-radius: 5px; }
</style>
...
<form action="<?php echo JRoute::_('index.php?option=com_modern_tours&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="review-form" class="form-validate">
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_MODERN_TOURS_TITLE_REVIEW', true)); ?>
		<div class="row-fluid">

 ...
 * @since  1.6
 */
class Modern_toursViewLocations extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Modern_toursHelper::addSubmenu('locations');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MODERN_TOURS_TITLE_LOCATIONS'), 'locations.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_modern_tours&view=locations');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_MODERN_TOURS_LOCATIONS_TITLE'),
			'a.`image`' => JText::_('COM_MODERN_TOURS_LOCATIONS_IMAGE'),
		);
	}

 ...
 * @since  1.6
 */
class Modern_toursViewReservation extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MODERN_TOURS_TITLE_RESERVATION'), 'reservation.png');
...
//			JToolbarHelper::versions('com_modern_tours.reservation', $this->item->id);
//		}

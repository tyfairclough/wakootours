 ...
 * @since  1.6
 */
class Modern_toursModelToursemails extends JModelList
{
...
/**
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__modern_tours_emails` AS a');
                
		// Join over the users for the checked out user
		$query->select("uc.name AS uEditor");
		$query->join("LEFT", "#__users AS uc ON uc.id=a.checked_out");

		$query->select('l.title AS title_native, l.title AS language_title, l.image AS language_image')
	...
	public function getItems()
	{
		...
		{
			$item->title = JText::sprintf('EMAIL_MESSAGE', $item->title_native);
		}
